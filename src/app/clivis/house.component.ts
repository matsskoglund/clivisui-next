...
export class HouseComponent implements OnInit,OnChanges{
    ...
    drawHouseOnCanvas() {          
        ...
        let outdoorFormatted:string = outdoor.toFixed(1);
        let indoorFormatted:string = indoor.toFixed(1);

        ctx.fillText(outdoorFormatted,100,130);

        ctx.fillText(indoorFormatted,250,575);  
        ctx.font = "14px Arial";
